  ...
  return (
    <div className="p-6 space-y-5 max-w-5xl mx-auto">
      ...
      {dashStats && (
        <section className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-medium text-gray-700">This Week</h2>
            <span className="text-xs text-gray-400">
              {dashStats.agents_connected} agent{dashStats.agents_connected !== 1 ? 's' : ''} connected
            </span>
          </div>
      ...
      {dashStats && dashStats.providers.length > 0 && (
        <section className="bg-white rounded-xl border border-gray-200 p-5">
          <h2 className="text-sm font-medium text-gray-700 mb-4">Provider Distribution (7 days)</h2>
