...
// TokenPricesSeedJSON is the byte content of data/token_prices.json,
// embedded at compile time. Contains the merged LiteLLM + supplement
// pricing data generated by scripts/update_prices.go. The daemon loads
// this as the initial price table before the first remote sync completes.
//
// Refreshed at runtime by internal/pricing from
// https://krouter.kinthai.ai/data/token_prices.json (primary) with
// fallback to https://raw.githubusercontent.com/kinthaiofficial/krouter/main/data/token_prices.json.
// The file is auto-updated daily by .github/workflows/update-litellm-prices.yml.
//
//go:embed token_prices.json
var TokenPricesSeedJSON []byte
